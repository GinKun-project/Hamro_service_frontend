  ...
  return (
    <div className="w-full min-h-screen flex items-center justify-center p-6 relative z-[1]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center max-w-[1200px] w-full">
        <AuthCard logo="Hamro Service" title="Login" subtitle="">
          <form onSubmit={handleSubmit} className="flex flex-col gap-6 w-full">
            ...
            <div className="text-right -mt-2">
              <Link href="/forgot-password" className="text-[var(--text-orange)] no-underline text-sm font-medium transition-[var(--transition)] hover:text-[var(--text-orange-dark)] hover:underline">
                Forgot Password?
              </Link>
            </div>
            ...
            <p className="text-center text-[var(--text-secondary)] text-sm mt-3">
              ...
              <Link href="/signup" className="text-[var(--text-orange)] no-underline font-medium transition-[var(--transition)] hover:text-[var(--text-orange-dark)] hover:underline">
                Register for free
              </Link>
            </p>
          </form>
